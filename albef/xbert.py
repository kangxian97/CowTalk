...
from transformers.file_utils import (
    ModelOutput,
    add_code_sample_docstrings as _add_code_sample_docstrings,
...
def add_code_sample_docstrings(*args, **kwargs):
    """Ignore ``tokenizer_class``, which newer ``transformers`` rejects."""
    kwargs.pop("tokenizer_class", None)
    try:
        return _add_code_sample_docstrings(*args, **kwargs)
    except TypeError:
        return lambda fn: fn
